...
cc.eventManager.addListener(e,this);this.updateHud();this.scheduleUpdate()},updateHud:function(){this.hudLayer.removeAllChildren();var a=cc.LabelTTF.create("Connect at least\n5 blocks to\nclear them\n\n\nSCORE:","Arial",20);a.setPosition(550,590);var b;b=this.score;b="undefined"===typeof b?"000000":("000000"+b).slice(-6);b=cc.LabelTTF.create(b,"Arial",40);b.setPosition(540,495);this.hudLayer.addChild(a,0);this.hudLayer.addChild(b,0)}}),e=cc.EventListener.create({event:cc.EventListener.KEYBOARD,onKeyReleased:function(a,
b){var c=b.getCurrentTarget(),d=c.player;switch(a){case 38:d.rotate(c);break;case 40:d.moveBy(0,-1,c);break;case 37:d.moveBy(-1,0,c);break;case 39:d.moveBy(1,0,c)}}});cc.game.onStart=function(){cc.LoaderScene.preload(a,function(){d();cc.director.runScene(new d)},this);window.focus();document.getElementById("game").focus()};cc.game.run("game")};window.onload=PrototypeGame;
