...
-1):(a.rotation=0,a.blocks[0].blockTypeId=a.blocks[3].blockTypeId,a.blocks[2].blockTypeId=-1,a.blocks[3].blockTypeId=-1)};this.undoRotation=function(){for(var b=0;3>b;b++)a.rotate()}},b=function(){var a=this;this.elapsedSinceLastUpdate=0;this.structure=new c;this.node=new cc.Node;this.node.setAnchorPoint(new cc.Point(0,-1));this.node.setPosition(64*Math.floor(3.5),512);this.nodeChanged=!0;this.reachedFinalPosition=!1;this.hasCollision=function(b){var c=!1;0>a.node.y&&0!=a.structure.rotation&&2!=a.structure.rotation&&
(c=!0);-64>a.node.y&&(c=!0);if(c)return!0;for(c=0;4>c;c++){var d=a.structure.blocks[c];if(-1<d.blockTypeId){var e=a.getPositionInGrid().x+d.x,d=a.getPositionInGrid().y+d.y;if(b.hasBlockAt(e,d))return!0}}return!1};this.positionWithinBoundaries=function(){0>a.node.x&&1!=a.structure.rotation&&3!=a.structure.rotation&&(a.node.x=0);-64>a.node.x&&(a.node.x=-64);320<a.node.x&&(a.node.x=320)};this.moveBy=function(b,c,d){a.node.x+=64*b;a.node.y+=64*c;a.positionWithinBoundaries();a.hasCollision(d.grid)&&(a.node.x+=
0-64*b,a.node.y+=0-64*c,0>c&&(a.reachedFinalPosition=!0))};this.getPositionInGrid=function(){return{x:a.node.x/64,y:a.node.y/64}};this.rotate=function(b){a.structure.rotate();a.hasCollision(b.grid)?a.structure.undoRotation():(a.nodeChanged=!0,a.positionWithinBoundaries())};this.update=function(b,c){if(a.nodeChanged){a.nodeChanged=!1;a.node.removeAllChildren();for(var d=0;4>d;d++){var e=a.structure.blocks[d].blockTypeId;-1<e&&(e=a.structure.createPlayerBlockSprite(e,d),a.node.addChild(e))}}.5<=(a.elapsedSinceLastUpdate+=
b)&&(a.moveBy(0,-1,c),a.elapsedSinceLastUpdate=0)}},d=cc.Scene.extend({blockLayer:{},hudLayer:{},player:{},grid:new function(){this.state=[];for(var a=0;70>a;a++)this.state.push(null);var b=this;this.addPlayerBlocks=function(a){for(var c=0;4>c;c++){var d=a.structure.blocks[c];if(-1<d.blockTypeId){var e=a.getPositionInGrid().x+d.x,f=a.getPositionInGrid().y+d.y,e=b.coordsToIndex(e,f);b.state[e]=d.blockTypeId}}};this.indexToCoords=function(a){return{x:a%7,y:Math.floor(a/7)}};this.coordsToIndex=function(a,
b){return 7*b+a};this.hasBlockAt=function(a,c){return null!==b.state[b.coordsToIndex(a,c)]};this.createBlockSprite=function(a,b,c){c=cc.Sprite.create("img/block"+c+".png");c.setAnchorPoint(new cc.Point(0,0));c.x=a;c.y=b;return c};this.dropFlyingBlocks=function(){var a;for(a=0;a<b.state.length;a++)if(null!==b.state[a]){var c=b.indexToCoords(a);9>c.y&&!b.hasBlockAt(c.x,c.y-1)&&(c=b.coordsToIndex(c.x,c.y-1),b.state[c]=b.state[a],b.state[a]=null,a=c-1)}};this.removeConnectingBlocks=function(){for(var a=
0,c=function(a,d,e){for(var f=b.indexToCoords(a),f=[{x:f.x,y:f.y-1},{x:f.x,y:f.y+1},{x:f.x-1,y:f.y},{x:f.x+1,y:f.y}],h=0;h<f.length;h++){var m=f[h],n=b.coordsToIndex(m.x,m.y);!(0>m.x||6<m.x||0>m.y||9<m.y)&&0<=n&&null!==b.state[n]&&b.state[n]==d&&-1==e.indexOf(n)&&(-1==e.indexOf(a)&&e.push(a),e.push(n),c(n,d,e))}},d=b.state.length-1;0<=d;d--)if(null!==b.state[d]){var e=[];c(d,b.state[d],e);if(5<=e.length){for(var f=0;f<e.length;f++)b.state[e[f]]=null;a+=e.length}}return a};this.update=function(a,c){b.addPlayerBlocks(c.player);
for(var d=null,e=0;0!==d;)e++,b.dropFlyingBlocks(),d=this.removeConnectingBlocks(),c.score+=100*d*e;c.updateHud();c.blockLayer.removeAllChildren();for(e=0;e<b.state.length;e++)null!==b.state[e]&&(d=b.indexToCoords(e),d=b.createBlockSprite(64*d.x,64*d.y,c.grid.state[e]),c.blockLayer.addChild(d))}},score:0,gameEnded:!1,update:function(a){this.player.update(a,this);this.player.reachedFinalPosition&&(this.grid.update(a,this),this.player=new b,this.blockLayer.addChild(this.player.node),this.player.hasCollision(this.grid)&&
(this.gameEnded=!0));this.gameEnded&&this.unscheduleUpdate()},onEnter:function(){this._super();var a=cc.Sprite.create("img/background.png");a.setAnchorPoint(new cc.Point(0,0));this.addChild(a,0);this.blockLayer=cc.Layer.create();this.blockLayer.setAnchorPoint(new cc.Point(0,0));this.addChild(this.blockLayer,1);this.hudLayer=cc.Layer.create();this.hudLayer.setAnchorPoint(new cc.Point(0,0));this.hudLayer.setPosition(0,-50);this.addChild(this.hudLayer,2);this.player=new b;this.blockLayer.addChild(this.player.node);
cc.eventManager.addListener(e,this);this.updateHud();this.scheduleUpdate()},updateHud:function(){this.hudLayer.removeAllChildren();var a=cc.LabelTTF.create("Connect at least\n5 blocks to\nclear them\n\n\nSCORE:\n\n\n\n\n\n\n\n\n\nUse arrow keys\nto move/rotate","Arial",20);a.setPosition(550,460);var b;b=this.score;b="undefined"===typeof b?"000000":("000000"+b).slice(-6);b=cc.LabelTTF.create(b,"Arial",40);b.setPosition(540,495);this.hudLayer.addChild(a,0);this.hudLayer.addChild(b,0)}}),e=cc.EventListener.create({event:cc.EventListener.KEYBOARD,
onKeyReleased:function(a,b){var c=b.getCurrentTarget(),d=c.player;switch(a){case 38:d.rotate(c);break;case 40:d.moveBy(0,-1,c);break;case 37:d.moveBy(-1,0,c);break;case 39:d.moveBy(1,0,c)}}});cc.game.onStart=function(){cc.LoaderScene.preload(a,function(){d();cc.director.runScene(new d)},this);window.focus();document.getElementById("game").focus()};cc.game.run("game")};window.onload=PrototypeGame;
